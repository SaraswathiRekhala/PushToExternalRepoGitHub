...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Override
    public Page<HqlCustomVacationDataResponse> executeHQL_CustomVacationData(Pageable pageable) {
        Map<String, Object> params = new HashMap<>(0);


        return queryExecutor.executeNamedQuery("HQL_CustomVacationData", params, HqlCustomVacationDataResponse.class, pageable);
    }

    @Transactional(value = "hrdbTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportHQL_CustomVacationData(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(0);
